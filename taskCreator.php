...
sec_session_start();
    ...
    <head>
        ...
        <meta name="title" content="Ajout de tâche - El Projector !"/>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="name_task" id="name_task" maxlength="500" 
        ...
        $( "select" ).change(function() {
            ...
            $("#form").submit(function(event){
                if (validateForm()) {
                    ...
                    <?php $comportement = (isset($_GET['edit'])) ? "window.location.replace('tasklist.php?project=".$nbproject."');":"window.location.replace('taskCreator.php');";?>
