...
<html lang="fr">
    ...
    <!-- Le bandeau principal avec le texte -->
        ...
        <button id="envoi" class="btn btn-info" type="button"><i class="glyphicon glyphicon-folder-open"></i> Nom renseigné</button>
        <button id="next" class="btn btn-warning" type="button"><i class="glyphicon glyphicon-plus"></i> Etape suivante</button>
        <button id="terminer" class="btn btn-success" type="button"><i class="glyphicon glyphicon-ok"></i> Terminer</button>
            ...
            $("#next").on('click',function(){
                $.ajax({
                        ...
                        data: {
                            name_modeleproject: $("#name_model") ,
                            id_etape: $("#id_etape") ,
                            name_etape: $("#name_etape") ,
                            dl_etape: $("#dl_etape") ,
                            duree_etape: $("#duree_etape") ,
                            period_etape: $("#period_etape") ,
                            prior_etape: $("#prior_etape") ,
                            token: "<?php echo $_SESSION['token']; ?>"
                    },
                })
            });
